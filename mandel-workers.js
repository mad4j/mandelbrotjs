...
needRedraw=1;if(needRedraw){for(i=0;i<workers;i++){
    // Use consistent chunk height for all workers to prevent fragmentation
    startLine = chunkHeight * i;
    const actualSegmentHeight = Math.min(chunkHeight, canvasHeight - startLine);
