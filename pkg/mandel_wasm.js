 ...
 */
export function mandel_one_shot(x_norm, y_norm, iter_max, smooth) {
 ...
 * @returns {Uint8Array}
 */
export function mandel_compute_segment(start_line, segment_height, canvas_width, screen_x, screen_y, zoom, iter_max, smooth, block_size) {
 ...
 */
export function mandel_compute_segment_with_smooth(start_line, segment_height, canvas_width, screen_x, screen_y, zoom, iter_max, block_size) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mandel_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
